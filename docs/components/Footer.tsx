...
export default function Footer() {
  ...
  return (
    <div className="border-t border-slate-200 bg-slate-100 pt-2 pb-4 dark:border-t-slate-800 dark:bg-transparent">
      <div className="mx-auto max-w-[90rem] px-4">
        <a
          className="inline-block"
          href="https://vercel.com?utm_source=next-intl&utm_campaign=oss"
