...
While `next-intl` works with all localization management platforms that support translating JSON files, `next-intl` recommends <PartnerContentLink name="localization-management-intro" href="https://crowdin.com">Crowdin</PartnerContentLink> for managing your translations.
...
1. Command-line integration with the <PartnerContentLink name="localization-management-developers-integrations" href="https://developer.crowdin.com/cli-tool/">Crowdin CLI</PartnerContentLink>
2. Git integration e.g. via the <PartnerContentLink name="localization-management-developers-integrations" href="https://support.crowdin.com/github-integration/">GitHub app</PartnerContentLink>
3. Automatic workflows triggered from <PartnerContentLink name="localization-management-developers-integrations" href="https://developer.crowdin.com/api/v2/#tag/Webhooks">webhooks</PartnerContentLink>
4. Over-the-air delivery via the <PartnerContentLink name="localization-management-developers-integrations" href="https://developer.crowdin.com/sdk-ota-web/">JS SDK</PartnerContentLink>
...
→ Head over to <PartnerContentLink name="localization-management-example" href="https://support.crowdin.com/introduction/">Crowdin</PartnerContentLink> to learn more.
