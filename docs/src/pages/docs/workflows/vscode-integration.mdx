...
1. [Loccy](#loccy)
2. [i18n Ally](#i18n-ally)
3. [Sherlock](#sherlock)

## Loccy

<video className="my-8" loop controls muted src="/loccy-demo.mp4" />

**Features:**

-  Basics: message extraction, inline annotations and editing, and links to all usages
-  AI: translate, create keypath, edit one locale and sync others, refine drafts, and more
-  Global AI rules, automatic term consistency
...
Learn more in the inlang docs: [Setting up next-intl with the Sherlock extension](https://inlang.com/m/193hsyds/plugin-inlang-nextIntl)
