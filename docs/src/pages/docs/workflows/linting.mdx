...
If you are using [locale-based routing](/docs/routing), you might want to ensure that developers consistently use the [navigation APIs](/docs/routing/navigation) that you've configured in your project.
