...
<summary>How can I precompile messages that are fetched at runtime?</summary>

If you fetch messages at runtime, you can compile them yourself before returning them:
