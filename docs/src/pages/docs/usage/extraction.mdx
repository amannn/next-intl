...
In the consuming app, you configure [`extract.path`](/docs/usage/plugin#extract-path) to only extract your first-party messages, while using [`messages.path`](/docs/usage/plugin#messages-path) to include the external package's messages:
