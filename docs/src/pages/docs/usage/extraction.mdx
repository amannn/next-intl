...
AI-based translation can be automated with the [eloqnt CLI](https://studio.eloqnt.dev) or a translation management system like [Crowdin](/docs/workflows/localization-management).
