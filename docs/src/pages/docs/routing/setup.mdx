...
**Note:** `next/root-params` is available by default in Next.js 16.3 and later. In earlier versions, it needs to be enabled via `experimental.rootParams` in your Next.js config.
