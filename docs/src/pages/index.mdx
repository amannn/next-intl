...
<Hero
  ...
  description="Support multiple languages, with your app code becoming simpler instead of complex."
  getStarted="Get started"
  viewExample="View an example"
  announcement={{
    href: 'https://learn.next-intl.dev',
    label: 'The next-intl course is out now!'
  }}
/>
...
>
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xl:gap-20">
    ...
    <FeaturePanel
      ...
      title="Dates, times, numbers & more"
...
<div className="text-center pb-10 -mt-10">
  <div className="py-60 relative">
    ...
    <div className='relative'>
      <LinkButton size='lg' href="/docs/getting-started">Get started with next-intl</LinkButton>
    </div>
  </div>
</div>
</div>
