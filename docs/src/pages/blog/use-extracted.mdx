...
But again, making something easy for AIs was probably always about making it easy for humans in the first place. And we already found a solution to this—wait for it—**35 years ago**!
...
Everything is there: A filename reference, an optional description, an ID and the label itself.
...
So from here, you can start translating your messages however you want, in the easiest case by using an AI-based translation service like <PartnerContentLink href="https://crowdin.com" title="Crowdin">Crowdin</PartnerContentLink>:
...
function InlineMessages() {
  ...
  // Production bundles use minified keys
