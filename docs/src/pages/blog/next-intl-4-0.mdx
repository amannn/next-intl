...
Last, but far from least, I'm incredibly excited about another Next.js feature coming up: [`rootParams`](https://github.com/vercel/next.js/pull/72837)
...
This is nothing short of a game-changer for `next-intl`, finally enabling static rendering for apps with i18n routing without workarounds like `setRequestLocale` and generally allowing the library to integrate much tighter with Next.js.

If you're using a setup with i18n routing, I'd encourage you to [give `rootParams` a try today](/blog/nextjs-root-params)!
