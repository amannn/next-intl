...
# Internationalization of Server & Client Components in Next.js

<Callout type="warning">

This page contains background information about the advantages of moving internationalization to Server Components. Note that this is currently only available in [the Server Components beta version of `next-intl`](/docs/getting-started/app-router-server-components). If you're on a stable release, you currently have to [use Client Components for internationalization](/docs/getting-started/app-router-client-components#usage).
