...
1. [`onError`](/docs/configuration#error-handling)
2. [`getMessageFallback`](/docs/configuration#error-handling)
3. Rich text elements for [`defaultTranslationValues`](/docs/configuration#default-translation-values)
