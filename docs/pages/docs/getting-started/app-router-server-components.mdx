...
1. [Handle internationalization in Client Components](/docs/getting-started/app-router-client-components) for the time being as static rendering is fully supported in this paradigm without limitations.
