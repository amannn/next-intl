...
With **Next.js 13** the [App Router](https://nextjs.org/docs/app) was introduced and with version 13.4 announced stable. Following the lead of Next.js, also `next-intl` recommends this paradigm going forward.
