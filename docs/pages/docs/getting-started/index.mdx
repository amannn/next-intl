...
With **Next.js 13**, the [App Router](https://nextjs.org/docs/app) was introduced and announced stable with version 13.4. Following the lead of Next.js, `next-intl` also recommends this paradigm going forward.
...
<div className="mt-8 flex flex-col gap-4 md:w-2/3">
  <Card
    ...
    title="Usage with the App Router and Client Components (stable)"
    href="/docs/getting-started/app-router-client-components"
  />
  <Card
    arrow
    icon={<SparklesIcon />}
    title="Usage with the App Router and Server Components (beta)"
    href="/docs/getting-started/app-router-server-components"
  />
  <Card
    arrow
    icon={<DocumentDuplicateIcon />}
    title="Usage with the Pages Router (existing apps)"
