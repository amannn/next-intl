...
Supplying `now` is necessary for the function to return consistent results. If you have [configured a global value for `now`](/docs/configuration#global-now-value), you can omit the second argument:
...
<Callout>
  ...
  [global formats](/docs/configuration#global-formats).
</Callout>
