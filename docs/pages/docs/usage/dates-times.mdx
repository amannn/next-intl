...
| :----: | :----------------------------------------------- | ---------------------------------------- | --------------------------------------------------- |
|   G    | Era designator (always includes date)            | G<br/>GGGG<br/>GGGGG                     | 7/9/2024 AD<br/>7/9/2024 Anno Domini<br/>7/9/2024 A |
...
|   E    | Day of week                                      | E<br/>EEEEE                              | Tue<br/>T                                           |
|   h    | Hour (1-12) (includes AM/PM)                     | h<br/>hh                                 | 9 AM<br/>09 AM                                      |
|   K    | Hour (0-11) (includes AM/PM)                     | K<br/>KK                                 | 0 AM (12 AM with `h`)<br/>00 AM                     |
|   H    | Hour (0-23)                                      | HH                                       | 09                                                  |
|   k    | Hour (1-24)                                      | kk                                       | 09                                                  |
|   m    | Minute (padded to 2 digits if used with seconds) | m<br/>mmss                               | 6<br/>06:03                                         |
|   s    | Second (padded to 2 digits if used with minutes) | s<br/>mmss                               | 3<br/>06:03                                         |
