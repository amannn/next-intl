...
If the amount of items varies depending on the locale, a common approach is to move the array to API data or a CMS where items can be dynamically created for a given locale.
