...
<details>
<summary>Can I use another style for structuring my messages?</summary>

Namespace keys can not contain the character "." as this is used to express nesting.
