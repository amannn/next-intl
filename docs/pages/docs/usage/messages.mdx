...
The other aspect to consider is that from a usability perspective, it can be helpful to consider additional forms on top—most commonly the special case for zero (e.g. "No followers yet" instead of "0 followers").
