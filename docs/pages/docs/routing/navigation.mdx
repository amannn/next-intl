...
<Callout>
  ...
  example with RSC support](https://github.com/amannn/next-intl/tree/feat/next-13-rsc/examples/example-next-13)
  to explore a working implementation of localized pathnames ([demo](https://next-intl-example-next-13-git-feat-next-13-rsc-next-intl.vercel.app/)).
</Callout>
