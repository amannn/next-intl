...
Depending on your routing needs, you may wish to configure further settings.

<Details id="locales-unknown">
<summary>What if the locales aren't known at build time?</summary>

In case you're building an app where locales can be added and removed at runtime, you can define the routing configuration for the middleware [dynamically per request](/docs/routing/middleware#composing-other-middlewares).
