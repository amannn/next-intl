...
export const localePrefix = 'always' satisfies LocalePrefixConfig;
```
...
export const localePrefix = 'as-needed' satisfies LocalePrefixConfig;
```
...
export const localePrefix = 'never' satisfies LocalePrefixConfig;
```
