...
<Example
  name="App Router (without routing)"
  hash="app-router-without-routing"
  description="An example that showcases basic usage of next-intl with the App Router, a statically provided locale and no routing setup."
  sourceLink="https://github.com/amannn/next-intl/tree/main/examples/example-app-router-without-routing"
/>
