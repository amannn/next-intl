...
Note that the `namespaces` can be a list that you generate dynamically based on used components. See the [example](https://github.com/amannn/next-intl/blob/main/packages/example/src/pages/index.tsx).
