...
export default function catalogLoader(
  ...
  getCodec(options, this.rootContext)
    .then((codec) => {
      ...
      const sourceLocale = options.messages.sourceLocale;
      let outputString: string;

      if (options.messages.precompile) {
        const decoded = codec.decode(source, {locale, sourceLocale});
        ...
        outputString = codec.toJSONString(source, {locale, sourceLocale});
      }
