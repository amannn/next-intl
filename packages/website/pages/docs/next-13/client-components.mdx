...
4. Set up [the i18n routing middleware](/docs/next-13/middleware) in `middleware.ts`. The middleware matches the locale of the request and handles redirects and rewrites accordingly.
