...
# Next.js 13 internationalization
...
1. Next.js is removing their built-in internationalized routing, leaving the implementation of this up to the user. To fill in the gap, `next-intl` provides a [drop-in middleware replacement for i18n routing](/docs/next-13/middleware), handling the locale negotiation, redirects, rewrites and cookies.
