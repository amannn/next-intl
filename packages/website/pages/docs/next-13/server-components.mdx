...
```
npm install next-intl@2.14.0-beta.1
```
...
1. Turn off [the `alternateLinks` option](/docs/next-13/middleware#disable-alternate-links) in the middleware and provide [search engine hints about localized versions of your content](https://developers.google.com/search/docs/specialty/international/localized-versions) by yourself.
