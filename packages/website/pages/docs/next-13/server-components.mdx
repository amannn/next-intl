...
To redirect the user to another page with the current locale, you can call `redirect` from a Server Component.

```tsx
import {redirect} from 'next-intl/server';

// When the user is on `/en`, this will be `/en/about`
redirect('/about');
```
