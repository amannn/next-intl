...
Note that you want to turn off the `alternateLinks` option in [the middleware](#middleware-configuration) in this case and provide [search engine hints about localized versions of your content](https://developers.google.com/search/docs/specialty/international/localized-versions) by yourself, as the middleware isn't aware of your rewrites.
