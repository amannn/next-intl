...
```js
intl.formatDateTime(new Date('2020-11-20T10:36:01.516Z'), 'short');
intl.formatNumber(new Date('2020-11-20T10:36:01.516Z'), 'short');
```

Global formats can also be referenced in messages.
