...
If you work with translators, it can be helpful for them to use an editor that supports the ICU syntax for numbers (e.g. the <PartnerContentLink href="https://support.crowdin.com/icu-message-syntax/#number">Crowdin Editor</PartnerContentLink>).
