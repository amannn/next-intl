...
To work with ICU messages, it can be helpful to use an editor that supports this syntax. E.g. the <PartnerLink href="https://support.crowdin.com/icu-message-syntax/">Crowdin Editor</PartnerLink> can be used by translators to set up messages without having to change app code.
