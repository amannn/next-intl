...
While the [installation instructions](/docs/getting-started/installation) are sufficient to use `next-intl` in your Next.js app, this checklist helps you ensure you're all set for production:
