...
For this example, we're going to use an example that is publicly available on GitHub: [Street Photography Viewer](https://github.com/amannn/street-photography-viewer). It's a Next.js 13 app that displays street photography pictures from Unsplash and uses `next-intl` for all internationalization needs.

Once you have a GitHub repository with your app, you can follow these steps:

1. Install <PartnerContentLink href="https://store.crowdin.com/github">the GitHub app from the Crowdin store</PartnerContentLink>
