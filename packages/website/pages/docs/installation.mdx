...
1. If you're using TypeScript you can take advantage of auto-completion and type safety for message keys by [setting up a type for your messages](/docs/usage/typescript).
