...
Note that the `namespaces` can be a list that you generate dynamically based on used components. See the [example](https://github.com/amannn/next-intl/tree/main/packages/example/src/pages/index.tsx).
