...
<Section
  ...
  description="Internationalization (i18n) is an essential part of the user experience, therefore next‑intl gives you everything you need to get language subtleties right and has always got your back whenever you need to fine-tune a translation."
>
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 xl:gap-20">
    ...
    <FeaturePanel
      ...
      description="Server/client differences like time zones are handled behind the scenes so you can focus on your code."
    />
    <FeaturePanel
