...
<header className="py-20">
  <h1 className="text-center text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">
    next-intl
  </h1>
...
<aside className="p-6 bg-emerald-50 border border-emerald-500 rounded-sm dark:nx-bg-primary-300/10 border-emerald-500/80">
  <b className="text-emerald-700">✨ New ✨ </b> `next-intl` is adding support
  for
  <b>Next.js 13</b> and the `app` directory. A preview version with support for React
  Server Components is [now available](/docs/next-13) for early adopters.
</aside>
