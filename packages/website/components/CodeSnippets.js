...
CodeSnippets.datesTimesNumbers = () => (
  <code data-language="js" data-theme="default">
    <span className="line">
...
CodeSnippets.typeSafe = () => (
  <code data-language="sh" data-theme="default">
    ...
    <span className="line">
      ...
      <span style={{color: 'var(--shiki-color-text)'}}> is not assignable</span>
    </span>
    <span className="line">
      <span style={{color: 'var(--shiki-color-text)'}}>
...
CodeSnippets.buildOutput = () => (
  <code data-language="sh" data-theme="default">
    ...
    <span className="line">
      <span style={{color: 'var(--shiki-color-text)'}}>┌ ● /</span>
      <span style={{color: 'var(--shiki-color-text)'}}> </span>
      <span style={{color: 'var(--shiki-color-text)'}}>{'          '}637</span>
...
CodeSnippets.standards = () => (
  <code data-language="js" data-theme="default">
    ...
    <span className="line"> </span>
    <span className="line">
      <span style={{color: 'var(--shiki-color-text)'}}>IntlMessageformat</span>
    </span>
  </code>
);
