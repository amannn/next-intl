export default function FeaturePanel({code, description, title}) {
  return (
    <div className="flex flex-col overflow-hidden rounded-md border border-slate-200 dark:border-slate-600">
      {code && (
        <div className="grow bg-white dark:bg-slate-900">
          <pre className="-ml-4 overflow-x-auto !p-4 md:!p-8">{code}</pre>
        </div>
      )}
      <div className="bg-slate-50 p-4 dark:bg-slate-800 md:p-8">
